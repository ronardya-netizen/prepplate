      ...
      <div style={{ background: "#fff", borderRadius: "20px 20px 0 0", marginTop: -8, paddingTop: 20 }}>
        ...
        <div style={{ margin: "0 16px 16px", background: "#f5f0e8", borderRadius: 14, padding: "16px" }}>
          ...
          <p style={{ fontSize: 12, color: "#a08060", fontWeight: 600, margin: 0, lineHeight: 1.7 }}>
            A portion of every PrepPlate subscription goes directly to trusted food partners, including food banks, school meal programs, and community kitchens. We share clear monthly numbers so you can see the real impact of your membership.
          </p>
        </div>
