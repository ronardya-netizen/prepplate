...
export default function NavBar() {
  ...
  const labels = {
    en: { home: "Home", pantry: "Pantry", discover: "Discover", plan: "Plan", profile: "Profile" },
    fr: { home: "Accueil", pantry: "Garde-manger", discover: "Découvrir", 
plan: "Planifier", profile: "Profil" },
  };

  const l = labels[lang];
  const linkStyle = { flex: 1, display: "flex", flexDirection: "column" as const, alignItems: "center" as const, gap: 3, padding: "8px 0 10px", textDecoration: "none", color: "#c09878", fontSize: 9, fontWeight: 700, fontFamily: "'Nunito', sans-serif" };
  ...
  return (
    <nav style={{ position: "fixed", bottom: 0, left: "50%", transform: "translateX(-50%)", width: "100%", maxWidth: 480, background: "#fff", borderTop: "1px solid #f0e8de", display: "flex", zIndex: 100 }}>
      ...
      <Link href="/pantry" style={linkStyle}>
